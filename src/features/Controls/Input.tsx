  ...
  return !!props.icon || !!props.pre ? (
    <div className={props.className}>
      <div className="relative">
        ...
        <input {...props} onChange={handleChange} className={classNames(DefaultClassNames, props.className, props.pre ? 'pl-16' : 'pl-10')} />
      </div>
    </div>
  ) : (
    <div className={classNames('relative w-full', props.className)}>
      <input {...props} onChange={handleChange} className={DefaultClassNames} />
      {showCharLimit && (
