...
const _LedgerDevice = (props: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 260 129" className={props.className || 'h-24'}>
    <defs>
    ...
    <g fill="none" fillRule="evenodd">
      <path
        className="prefix__ledger-nano_svg__ledger-stroke"
        stroke="#1D2027"
        strokeWidth={2}
        d="M127.856 31.44a1 1 0 01-1 1H100.63a5 5 0 01-5-5v-8.486a5 5 0 015-5h26.225a1 1 0 011 1v16.485z"
      />
      <path className="prefix__ledger-nano_svg__ledger-stroke" stroke="#142533" strokeWidth={2} d="M95.247 26.231H84.318v-6.435h10.93v6.435z" />
      <path
        className="prefix__ledger-nano_svg__ledger-stroke"
        stroke="#1D2027"
        strokeWidth={2}
      ...
      <g transform="rotate(-90 128.59 1.975)">
        <rect className="prefix__ledger-nano_svg__ledger-fill" width={4.492} height={17.12} x={125.336} y={15.505} fill="#142533" rx={2} />
        <rect className="prefix__ledger-nano_svg__ledger-fill" width={4.492} height={17.12} x={125.336} y={70.094} fill="#142533" rx={2} />
        <use className="prefix__ledger-nano_svg__ledger-fill-inner-bg" fill="#FFF" xlinkHref="#prefix__b" />
        <path
          className="prefix__ledger-nano_svg__ledger-stroke"
          fill="#6490F1"
          fillOpacity={0.15}
        ...
        />
        <rect
          className="prefix__ledger-nano_svg__ledger-fill-outer-bg"
          width={21}
          height={62}
          x={97.5}
          y={21.5}
        ...
        />
        <path
          className="prefix__ledger-nano_svg__ledger-stroke prefix__ledger-nano_svg__ledger-fill-outer-bg"
          fill="#FFF"
          stroke="#142533"
          strokeWidth={2}
